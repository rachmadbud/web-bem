        ...
        <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo">
              <img src="{{ asset('/img_bem/logo/ubl.PNG')}}" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo">
              <img src="{{ asset('/img_bem/logo/logo-bem.PNG')}}" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo">
              <img src="{{ asset('/img_bem/logo/fik.PNG')}}" class="img-fluid" alt="">
            </div>
          </div>

          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="client-logo">
              <img src="{{ asset('/img_bem/logo/kabinet.PNG')}}" class="img-fluid" alt="">
            </div>
          </div>
